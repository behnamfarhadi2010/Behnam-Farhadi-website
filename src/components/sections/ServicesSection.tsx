  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <h2 className="text-[#0C0C0C] font-black uppercase text-center tracking-tight text-[clamp(3rem,12vw,160px)] mb-16 sm:mb-20 md:mb-28">
          Services
        </h2>
        ...
        <div className="max-w-5xl mx-auto flex flex-col">
          {SERVICES.map((service, i) => (
            <FadeIn 
              key={service.num} 
              delay={i * 0.1}
              className="border-t border-[#0C0C0C]/15"
            >
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-16 py-8 sm:py-10 md:py-12">
                <span className="font-black text-[#0C0C0C] leading-none text-[clamp(3rem,10vw,140px)] md:w-32">
                  {service.num}
                </span>
